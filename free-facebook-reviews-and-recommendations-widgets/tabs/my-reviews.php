...
"showLines": 2,
"lessText": "'. esc_html(__('Show less', 'free-facebook-reviews-and-recommendations-widgets')) .'",
"moreText": "'. esc_html(__('Show more', 'free-facebook-reviews-and-recommendations-widgets')) .'",
});
...
?>
<div class="ti-header-title"><?php echo esc_html(__('My Reviews', 'free-facebook-reviews-and-recommendations-widgets')); ?></div>
<div class="ti-box">
<?php if (!$isReviewDownloadInProgress): ?>
<?php if ($reviewDownloadFailed): ?>
<div class="ti-notice ti-notice-error">
<p><?php echo esc_html(__('The manual review download not available yet.', 'free-facebook-reviews-and-recommendations-widgets')); ?></p>
</div>
<?php endif; ?>
...
<?php echo esc_html(__('Download new reviews', 'free-facebook-reviews-and-recommendations-widgets'));?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Now, you can download your new reviews.', 'free-facebook-reviews-and-recommendations-widgets')); ?></span>
</a>
<?php else: ?>
...
/* translators: %d: days */
echo esc_html(sprintf(__('The manual review download will be available again in %d day(s).', 'free-facebook-reviews-and-recommendations-widgets'), $days));
?></span>
</a>
<?php endif; ?>
...
<strong><?php echo esc_html(__('UPGRADE to PRO Features', 'free-facebook-reviews-and-recommendations-widgets')); ?></strong>
<p><?php
/* translators: %d: platform number */
echo esc_html(sprintf(__('Automatic review update, creating unlimited review widgets, downloading and displaying all reviews, %d review platforms available!', 'free-facebook-reviews-and-recommendations-widgets'), 137));
?></p>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton('wp-facebook-pro')); ?>
</div>

<?php if (!count($reviews)): ?>
<?php if (!$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning">
<p><?php echo esc_html(__('You had no reviews at the time of last review downloading.', 'free-facebook-reviews-and-recommendations-widgets')); ?></p>
</div>
<?php endif; ?>
<?php else: ?>
...
<thead>
<tr>
<th class="ti-text-center"><?php echo esc_html(__('Reviewer', 'free-facebook-reviews-and-recommendations-widgets')); ?></th>
<th class="ti-text-center" style="width: 90px;"><?php echo esc_html(__('Rating', 'free-facebook-reviews-and-recommendations-widgets')); ?></th>
<th class="ti-text-center"><?php echo esc_html(__('Date', 'free-facebook-reviews-and-recommendations-widgets')); ?></th>
<th style="width: 50%"><?php echo esc_html(__('Text', 'free-facebook-reviews-and-recommendations-widgets')); ?></th>
</tr>
</thead>
<tbody>
...
<td class="ti-text-center source-<?php echo esc_attr(ucfirst("facebook")); ?>"><?php echo wp_kses_post(trustindex_plugin_write_rating_stars($review->rating)); ?></td>
...
<?php if ($review->reply): ?>
<a href="#" class="ti-btn ti-btn-default ti-btn-sm ti-btn-default-disabled btn-show-ai-reply"><?php echo esc_html(__('Reply', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php else: ?>
<a href="#" class="ti-btn ti-btn-sm btn-show-ai-reply" data-edit-reply-text="<?php echo esc_html(__('Reply', 'free-facebook-reviews-and-recommendations-widgets')); ?>"><?php echo esc_html(__('Reply with ChatGPT', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php endif; ?>
<?php endif; ?>
<?php if ($review->text): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="ti-btn ti-btn-sm ti-btn-default btn-show-highlight<?php if (isset($review->highlight) && $review->highlight): ?> has-highlight<?php endif; ?>"><?php echo esc_html(__('Highlight text', 'free-facebook-reviews-and-recommendations-widgets')) ;?></a>
<?php endif; ?>
<?php endif; ?>
...
<?php if (!$review->hidden): ?>
<?php echo esc_html(__('Hide review', 'free-facebook-reviews-and-recommendations-widgets')); ?>
<?php else: ?>
<?php echo esc_html(__('Show review', 'free-facebook-reviews-and-recommendations-widgets')); ?>
<?php endif; ?>
</a>
...
<strong><?php echo esc_html(__('ChatGPT generated reply', 'free-facebook-reviews-and-recommendations-widgets')); ?></strong>
<span><?php echo esc_html(__('you can modify before upload', 'free-facebook-reviews-and-recommendations-widgets')); ?>
</div>
<textarea id="ti-ai-reply-<?php echo esc_attr($review->id); ?>" rows="1"></textarea>
<?php if (!$review->text): ?>
<div class="ti-alert ti-alert-empty-review d-none"><?php echo esc_html(__("The reply was generated in your widget language because the review's text is empty.", 'free-facebook-reviews-and-recommendations-widgets')); ?></div>
<?php endif; ?>
...
echo esc_html(sprintf(__('Upload reply to %s', 'free-facebook-reviews-and-recommendations-widgets'), 'Facebook'));
?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-ai-reply"><?php echo esc_html(__('Cancel', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
</div>
...
<strong><?php
/* translators: %s: Name */
echo esc_html(sprintf(__('Reply by %s', 'free-facebook-reviews-and-recommendations-widgets'), $pageDetails['name']));
?></strong>
</div>
<div class="ti-alert ti-d-none"><?php echo esc_html(__('Reply successfully uploaded.', 'free-facebook-reviews-and-recommendations-widgets')); ?></div>
<p><?php echo esc_html($review->reply); ?></p>
<?php if ($pluginManagerInstance->getShortName() === 'google'): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="ti-btn ti-btn-sm ti-btn-white btn-show-edit-reply"><?php echo esc_html(__('Edit reply', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php endif; ?>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Copy the reply', 'free-facebook-reviews-and-recommendations-widgets')); ?></strong>
</div>
<div class="ti-alert ti-alert-warning ti-d-none">
<?php echo esc_html(__('We could not connect your account with the review.', 'free-facebook-reviews-and-recommendations-widgets')); ?>
<a href="#" class="btn-try-reply-again"><?php echo esc_html(__('Try again', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Highlight text', 'free-facebook-reviews-and-recommendations-widgets')); ?></strong>
<span><?php echo esc_html(__('just select the text you want to highlight', 'free-facebook-reviews-and-recommendations-widgets')); ?>
</div>
...
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm btn-save-highlight"><?php echo esc_html(__('Save', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-highlight"><?php echo esc_html(__('Cancel', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php if ($review->highlight): ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm ti-btn-danger ti-pull-right btn-remove-highlight"><?php echo esc_html(__('Remove highlight', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php endif; ?>
</div>
<?php endif; ?>
</td>
