...
<a href="<?php echo esc_attr(str_replace('%step%', $stepCurrent - 1, $stepUrl)); ?>" class="ti-btn ti-btn-default"><?php echo esc_html(__('Back', 'free-facebook-reviews-and-recommendations-widgets')); ?></a>
<?php endif; ?>
