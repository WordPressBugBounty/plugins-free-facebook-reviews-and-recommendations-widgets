...
<?php echo esc_html(__('Example Widget', 'free-facebook-reviews-and-recommendations-widgets')); ?>:
...
<div class="preview"><?php echo wp_kses($pluginManagerInstance->renderWidgetFrontend('a1e754a36568236614dccc191', true), $pluginManager::$allowedAttributesForWidget); ?></div>
</div>
</div>
</div>
<?php
