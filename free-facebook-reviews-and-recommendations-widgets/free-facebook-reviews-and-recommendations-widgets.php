...
$trustindex_pm_facebook = new TrustindexPlugin_facebook("facebook", __FILE__, "13.1", "Widgets for Reviews & Recommendations", "Facebook");
...
<p>
<a href="<?php echo admin_url("admin.php?page=free-facebook-reviews-and-recommendations-widgets/settings.php&wc_notification=open"); ?>" target="_blank" class="ti-close-notification" style="text-decoration: none">
<button class="button button-primary"><?php echo __('Download plugin', 'trustindex-plugin'); ?></button>
</a>
<a href="<?php echo admin_url("admin.php?page=free-facebook-reviews-and-recommendations-widgets/settings.php&wc_notification=hide"); ?>"target="_blank" class="ti-hide-notification" style="text-decoration: none">
