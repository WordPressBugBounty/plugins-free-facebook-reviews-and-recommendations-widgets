...
return '<a class="ti-btn" href="https://lp.trustindex.io/'.$this->getShortName().'-wp/?a=sys&c='. $campaignId .'" target="_blank">'. __('Create a Free Account for More Features', 'free-facebook-reviews-and-recommendations-widgets') .'</a>';
}
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-13.2.7", "do-not-care-Widgets for Reviews & Recommendations", "do-not-care-Facebook");
...
return $this->frontEndErrorForAdmins(__('Free plugin features are unavailable with AMP plugin.', 'free-facebook-reviews-and-recommendations-widgets'));
}
...
if (!$reviews) {
return self::get_alertbox('error', __('You do not have reviews with the current filters. <br />Change your filters if you would like to display reviews on your page!', 'free-facebook-reviews-and-recommendations-widgets'));
}
