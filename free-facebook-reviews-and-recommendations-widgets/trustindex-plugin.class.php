...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-13.1", "do-not-care-Widgets for Reviews & Recommendations", "do-not-care-Facebook");
...
'<img class="ti-recommendation-icon" src="https://cdn.trustindex.io/assets/platform/Facebook/recommendation-negative.svg" alt="Facebook" width="15" height="15" loading="lazy" />',
'<img class="ti-recommendation-icon" src="https://cdn.trustindex.io/assets/platform/Facebook/recommendation-positive.svg" alt="Facebook" width="15" height="15" loading="lazy" />',
